...
class ApiService{
  ...
  Future<Response?> updateProfile() async{
    ...
    String birthday = "";
    Map<String, dynamic> param = {
      "first_name" : profile.user.frist_name,
      ...
      "provinceid": profile.user.provinceid ?? 0,
      "provincename": profile.user.provincename ?? "",
      "districtid": profile.user.districtid ?? 0,
      "districtname": profile.user.districtname ?? "",
      "wardid": profile.user.wardid ?? 0,
  ...
  Future<Response?> getDslop() async{
    ...
    String apiUrl = "http://chocaycanh.club/api/lophoc/ds";
    try{
